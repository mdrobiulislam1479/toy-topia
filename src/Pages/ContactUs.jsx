...
const ContactPage = () => {
  ...
  return (
    <section className="relative bg-gray-900 text-white py-10 md:py-0 px-6 overflow-hidden">
      <div
      ...
      <div className="relative max-w-[1440px] mx-auto min-h-screen grid grid-cols-1 md:grid-cols-2 gap-10 items-center z-10">
        <div
        ...
        <div
          className="space-y-8 bg-black/30 p-8 rounded shadow-lg"
          data-aos="zoom-in"
        >
